...
description: Customize your documentation space with themes, branding, and settings to match your project needs.
---
...
<Columns cols={2}>
  <Card title="Themes & Layouts" icon="palette" href="#themes">
    Switch between light/dark modes and layouts.
  </Card>
  <Card title="Branding" icon="brush" href="#branding">
